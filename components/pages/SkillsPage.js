...
export default function SkillsPage() {
    return (
        <div className="bg-white mx-auto flex flex-col items-center justify-start min-h-screen py-24 min-w-fit">
            <div className="md:text-4xl text-2xl text-gray-900 font-bold">My skills</div>
                ...
                {[
                    ...
                    <div className="flex flex-col gap-1 items-center justify-center" key={title}>
                        <div className="relative pt-1">
                            ...
                            <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-rose-100 lg:w-96 w-72">
