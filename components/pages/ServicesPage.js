...
export default function ServicesPage() {
    return (
        <div className="bg-zinc-900 mx-auto flex flex-col items-center justify-center min-h-screen py-24 min-w-fit">
            ...
            <div className="md:text-2xl text-rose-700 font-bold">what i provide</div>
            <div className="flex lg:flex-row flex-col gap-5 items-center justify-between mt-14 px-10">
                <div className="bg-cyan-700 lg:w-96 md:w-80 w-60 h-60 rounded-lg overflow-hidden shadow-lg flex items-center justify-center hover:bg-rose-700">
